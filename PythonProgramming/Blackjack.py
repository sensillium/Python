...
# Blackjack
# For 1 to 7 players against the dealer

import cards1, games

class BJ_Card(cards1.Card):
    """A Blackjack card"""
    ACE_VALUE=1
...
class BJ_Hand(cards1.Hand):
    ...
    def total(self):
        ...
        # to add up card values, treat each Ace as 1
        t=0
        for card in self.cards:
            t+=card.value
        ...
        if contains_ace and t<=11:
            # add only 10 as we have already added 1 for the Ace
            t+=10
